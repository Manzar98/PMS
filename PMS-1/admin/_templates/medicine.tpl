...
<div id="content">
	<div class="container-fluid">
		...
		{else}
		<h2>{if $smarty.get.q neq ''} Search Result For "<b>{$smarty.get.q}</b>" {else}Medicine List{/if}</h2>
		<p>
			<a href="{$BASE_URL_ADMIN}medicine/add/" title="Add new"><i class="fa fa-plus-square" aria-hidden="true"></i></a>
		</p>
