...
<div id="content">
	<div class="container-fluid">
		<h2>{if $smarty.get.q neq ''} Search Result For "<b>{$smarty.get.q}</b>" {else}Patient List{/if}</h2>
		<p>
			<a href="{$BASE_URL_ADMIN}patients/add/" title="Add a new patient"><i class="fa fa-plus-square" aria-hidden="true"></i></a>
		</p>
