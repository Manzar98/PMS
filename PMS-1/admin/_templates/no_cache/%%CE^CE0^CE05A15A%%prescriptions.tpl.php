<?php /* Smarty version 2.6.26, created on 2012-09-02 15:19:30
...
?>
				...
				<h2 class="noprint"><?php if ($_GET['q'] != ''): ?> Search Result For "<b><?php echo $_GET['q']; ?>
...
prescriptions/" method="get" enctype="multipart/form-data">
				...
				<select name="field" id="field">
					<option value="id" <?php if ($this->_tpl_vars['search']['field'] == 'id'): ?> selected="selected" <?php endif; ?>>Prescription ID</option>
					<option value="patient_id" <?php if ($this->_tpl_vars['search']['field'] == 'patient_id'): ?> selected="selected" <?php endif; ?>>Patient ID</option>
					<option value="patient_name" <?php if ($this->_tpl_vars['search']['field'] == 'patient_name'): ?> selected="selected" <?php endif; ?>>Patient Name</option>
					<option value="created_on" <?php if ($this->_tpl_vars['search']['field'] == 'created_on'): ?> selected="selected" <?php endif; ?>>Date</option>
					<option value="complain" <?php if ($this->_tpl_vars['search']['field'] == 'complain'): ?> selected="selected" <?php endif; ?>>Complain</option>
				</select>
				
				<input type="text" name="q" id="q" value="<?php echo $this->_tpl_vars['search']['q']; ?>
" maxlength="20" />
