				...
				<fieldset>
					...
					<div class="row">
						<div class="col-sm-4 common-bottom">
							...
							<input type="text" name="name" id="name" class="form-control" {if (isset($data) && $data.name)}value="{$data.name}"{/if}/>
						</div>
						<div class="col-sm-4 common-bottom">
					...
					<div class="row">
						...
						<div class="col-sm-4 common-bottom">
							...
							<input type="password" name="password" id="password"class="form-control" {if (isset($data) && $data.password)}value="{$data.password}"{/if}/>
						</div>
