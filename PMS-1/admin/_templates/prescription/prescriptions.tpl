...
<div id="content">
	<div class="container-fluid">
		...
		<h2 class="noprint">{if (isset($smarty.get.q) && $smarty.get.q neq '')} Search Result For "<b>{$smarty.get.q}</b>" {else}Prescription List{/if}</h2>
		
		<p class="noprint">

			<a href="{$BASE_URL_ADMIN}add-prescription/" title="Add a new Prescription"><i class="fa fa-plus-square" aria-hidden="true"></i></a>
		</p>
		...
		<div id="prescription_info">
			...
			<div>
				<ul class="patient_info list-inline">
					...
					<li><span style="font-weight: normal;">Gender: <span>{$data.patient.gender}</span></span></li>
