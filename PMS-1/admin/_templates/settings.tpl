		...
		<div class="list common-top">
			...
			<div class="row {cycle values='odd,even'}">
				...
				<div class="col-sm-4" style="padding-bottom: 30px;">
					<a class="pull-right" href="{$BASE_URL_ADMIN}settings/{$settings_categories[tmp].var_name}/" title="Edit {$settings_categories[tmp].name}"><img src="{$BASE_URL_ADMIN}_templates/img/pencil.png" alt="Edit" style="padding-top: 8px;" /></a>
				</div>
			</div>
			{/section}
		</div>
