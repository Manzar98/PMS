<?php /* Smarty version 2.6.31, created on 2018-08-20 12:14:45
         compiled from users/users.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'users/users.tpl', 84, false),array('function', 'cycle', 'users/users.tpl', 101, false),)), $this); ?>
...
add-users/" title="Add a new User"><i class="fa fa-plus-square" aria-hidden="true"></i></a>
			</p>
...
_templates/img/bin.png" alt="Delete" /></a>
				...
				<div class="row">
					<div class="col-sm-10">
						<h3 class="noprint" ><?php echo $this->_tpl_vars['data']['username']; ?>
's Details</h3>
					</div>
					<div class="col-sm-2">
...
<div style="margin-top: 30px;"></div>
				<div class="row ">
					...
					<div class="col-sm-4 common-bottom">
						<span><b>Clinic Name : </b><span><?php echo $this->_tpl_vars['data']['clinic']; ?>
</span></span>
					</div>
				</div>
				<div class="row">
