<?php /* Smarty version 2.6.31, created on 2018-08-20 13:01:08
				...
				<fieldset>
					...
					<div class="row">
						<div class="col-sm-4 common-bottom">
							...
							<input type="text" name="name" id="name" class="form-control" <?php if (( isset ( $this->_tpl_vars['data'] ) && $this->_tpl_vars['data']['name'] )): ?>value="<?php echo $this->_tpl_vars['data']['name']; ?>
"<?php endif; ?>/>
						</div>
						<div class="col-sm-4 common-bottom">
