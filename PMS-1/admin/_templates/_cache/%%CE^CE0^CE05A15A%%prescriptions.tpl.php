<?php /* Smarty version 2.6.31, created on 2018-08-16 20:07:59
         compiled from prescription/prescriptions.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'prescription/prescriptions.tpl', 112, false),array('modifier', 'default', 'prescription/prescriptions.tpl', 134, false),array('function', 'cycle', 'prescription/prescriptions.tpl', 131, false),)), $this); ?>
...
add-prescription/" title="Add a new Prescription"><i class="fa fa-plus-square" aria-hidden="true"></i></a>
		</p>
...
_templates/img/bin.png" alt="Delete" /></a>
		...
		<div id="prescription_info">
			<div class="row">
				<div class="col-sm-10">
					<h3 class="noprint" >Patient's Details</h3>
				</div>
				<div class="col-sm-2">
			...
			<div>
				<ul class="patient_info list-inline">
					...
					<li><span style="font-weight: normal;">Gender: <span><?php echo $this->_tpl_vars['data']['patient']['gender']; ?>
</span></span></li>
