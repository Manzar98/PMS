...
elseif($_POST)
{
	...
	if($q!='')			
	{
		...
		$total_searched_instructions = $instruction->CountSearchedInstructions($q,$field);
		...
		$instruction_list = $instruction->GetInstructionsBySearch($q,$field,$firstLimit,PAGINATION);
		...
		$instruction_list = $instruction->GetInstructions($firstLimit,PAGINATION);
