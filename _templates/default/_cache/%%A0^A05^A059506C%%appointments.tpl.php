<?php /* Smarty version 2.6.31, created on 2018-12-12 18:22:02
         compiled from appointments/appointments.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'appointments/appointments.tpl', 54, false),)), $this); ?>
...
/" class="docCard">
					<div class="card text-center cardWrap">
						<img class="card-img-top" src="<?php echo $this->_tpl_vars['BASE_URL']; ?>
...
history/" class="btn btn-primary">Veiw History</a>
	...
	<div class="row" style="margin-bottom: 20px;">
		<div class="text-center center-block"> <img src="<?php echo $this->_tpl_vars['BASE_URL']; ?>
