...
portal/_templates/css/print.css" type="text/css" media="print" />
	
	<!-- <link href="<?php echo $this->_tpl_vars['BASE_URL']; ?>
portal/_templates/vendor/datatables/dataTables.bootstrap4.css" rel="stylesheet"> -->
	<!-- Main styles -->
	<link href="<?php echo $this->_tpl_vars['BASE_URL']; ?>
portal/_templates/css/custom.css" rel="stylesheet">
	<!-- Main styles -->
	<!-- <link href="<?php echo $this->_tpl_vars['BASE_URL']; ?>
portal/_templates/css/admin.css" rel="stylesheet"> -->
		 <!-- <link rel="stylesheet" href="<?php echo $this->_tpl_vars['BASE_URL_ADMIN']; ?>
_templates/css/screen.css" type="text/css" media="screen" /> -->
	<!-- <link rel="stylesheet" href="<?php echo $this->_tpl_vars['BASE_URL']; ?>
portal/_templates/css/jquery.fancybox.css" type="text/css" media="screen" />  -->
	<link rel="stylesheet" href="<?php echo $this->_tpl_vars['BASE_URL']; ?>
portal/_templates/css/jquery-ui.css">
...
" alt=""  class="img-responsive">
 ...
 Years of Exprience</span></div>
					...
					<div class="" style="width: 20%; margin:0 auto;margin-top: 40px; margin-bottom: 40px;" > 
						...
						<span><b><?php echo $this->_tpl_vars['record']['name']; ?>
</b></span>
...
<script src="<?php echo $this->_tpl_vars['BASE_URL']; ?>
_templates/<?php echo $this->_tpl_vars['THEME']; ?>
/js/categories.js" type="text/javascript"></script>
<script src="<?php echo $this->_tpl_vars['BASE_URL']; ?>
_templates/<?php echo $this->_tpl_vars['THEME']; ?>
/js/hoverIntent.js" type="text/javascript"></script>
<script src="<?php echo $this->_tpl_vars['BASE_URL']; ?>
_templates/<?php echo $this->_tpl_vars['THEME']; ?>
/js/links.js" type="text/javascript"></script>
<script src="<?php echo $this->_tpl_vars['BASE_URL']; ?>
_templates/<?php echo $this->_tpl_vars['THEME']; ?>
/js/select2.js" type="text/javascript"></script>
<script src="<?php echo $this->_tpl_vars['BASE_URL']; ?>
_templates/<?php echo $this->_tpl_vars['THEME']; ?>
...
<script src="<?php echo $this->_tpl_vars['BASE_URL']; ?>
_templates/<?php echo $this->_tpl_vars['THEME']; ?>
/js/types.js" type="text/javascript"></script>
<script src="<?php echo $this->_tpl_vars['BASE_URL']; ?>
_templates/<?php echo $this->_tpl_vars['THEME']; ?>
...
<script src="<?php echo $this->_tpl_vars['BASE_URL']; ?>
_templates/<?php echo $this->_tpl_vars['THEME']; ?>
/js/datepicker.js" type="text/javascript"></script>
<script src="<?php echo $this->_tpl_vars['BASE_URL']; ?>
_templates/<?php echo $this->_tpl_vars['THEME']; ?>
/js/accordion.js"></script>
<script src="<?php echo $this->_tpl_vars['BASE_URL']; ?>
_templates/<?php echo $this->_tpl_vars['THEME']; ?>
/js/croppie.js"></script>
<?php echo '
<style type="text/css">
.datetimeHeading{
	margin-bottom: 10px;
