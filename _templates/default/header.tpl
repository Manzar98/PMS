...
<!-- Mirrored from www.ansonika.com/findoctor/index-4.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 27 Nov 2018 11:16:32 GMT -->
<head>
	<meta charset="utf-8">
	...
	<!-- Favicons-->
	<link rel="shortcut icon" href="{$BASE_URL}_templates/{$THEME}/img/favicon.ico" type="image/x-icon">
	<link rel="apple-touch-icon" type="image/x-icon" href="{$BASE_URL}_templates/{$THEME}/img/apple-touch-icon-57x57-precomposed.png">
	<link rel="apple-touch-icon" type="image/x-icon" sizes="72x72" href="{$BASE_URL}_templates/{$THEME}/img/apple-touch-icon-72x72-precomposed.png">
	<link rel="apple-touch-icon" type="image/x-icon" sizes="114x114" href="{$BASE_URL}_templates/{$THEME}/img/apple-touch-icon-114x114-precomposed.png">
	<link rel="apple-touch-icon" type="image/x-icon" sizes="144x144" href="{$BASE_URL}_templates/{$THEME}/img/apple-touch-icon-144x144-precomposed.png">

	<!-- BASE CSS -->
	<link href="{$BASE_URL}_templates/{$THEME}/css/bootstrap.min.css" rel="stylesheet">
	<link href="{$BASE_URL}_templates/{$THEME}/css/style.css" rel="stylesheet">
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-3 col-6">
					<div id="logo_home">
						<h1><a href="index-2.html" title="Findoctor">Findoctor</a></h1>
					</div>
				</div>
				<div class="col-lg-9 col-6">
					...
					<nav id="menu" class="main-menu">
						<ul>
							...
							<li><span><a href="portal/" target="_blank">Admin</a></span></li>
