...
<link rel="stylesheet" href="{$BASE_URL}portal/_templates/css/print.css" type="text/css" media="print" />
	
	<!-- <link href="{$BASE_URL}portal/_templates/vendor/datatables/dataTables.bootstrap4.css" rel="stylesheet"> -->
	<!-- Main styles -->
	<link href="{$BASE_URL}portal/_templates/css/custom.css" rel="stylesheet">
	<!-- Main styles -->
	<!-- <link href="{$BASE_URL}portal/_templates/css/admin.css" rel="stylesheet"> -->
		 <!-- <link rel="stylesheet" href="{$BASE_URL_ADMIN}_templates/css/screen.css" type="text/css" media="screen" /> -->
	<!-- <link rel="stylesheet" href="{$BASE_URL}portal/_templates/css/jquery.fancybox.css" type="text/css" media="screen" />  -->
	<link rel="stylesheet" href="{$BASE_URL}portal/_templates/css/jquery-ui.css">
...
<div id="" class="publicWrap content-wrapper">
			...
			<fieldset>
				...
				<div class="container doctorStyleCard">
					<div class="row" style="padding: 10px;    padding-top: 20px;">
						<div class="col-sm-2"> 
							<img src="{$BASE_URL}portal/{$smarty.get.img}" alt=""  class="img-responsive">
						</div>
						<div class="col-sm-7 ">
					...
					<div class="" style="width: 20%; margin:0 auto;margin-top: 40px; margin-bottom: 40px;" > 
			...
			<form id="check_patient" class="box style" action="{$smarty.server.REQUEST_URI}" method="post">
				<div class="row">
					...
					<div class="" style="padding-top: 24px;">
						<a href="{$BASE_URL}add-appointment/{$smarty.get.doc_id}?doc_name={$smarty.get.doc_name}&doc_adr={$smarty.get.doc_adr}&doc_phne={$smarty.get.doc_phne}&img={$smarty.get.img}&speciallist={$smarty.get.speciallist}&pkgId={$smarty.get.pkgId}&exprience={$smarty.get.exprience}&fee={$smarty.get.fee}" class="btn btn-primary">New Patient</a>
					</div>
				</div>
			</form>
			{else}
				...
				<fieldset>
					...
					<div class="container doctorStyleCard">
						<div class="row" style="padding: 10px;    padding-top: 20px;">
							...
							<div class="col-sm-3 pull-right expri-div">
								<div style="margin-bottom: 12px;">
									<span class="text-center"><i class="fa fa-star-o" aria-hidden="true"></i>&nbsp;&nbsp;{$smarty.get.exprience} Years of Exprience</span>
								</div>
								<span><i class="fa fa-money" aria-hidden="true"></i>&nbsp;&nbsp;Rs. {$smarty.get.fee}</span>
							</div>
						</div>
...
<script src="{$BASE_URL}_templates/{$THEME}/js/jquery.validate.min.js" type="text/javascript"></script>
<script src="{$BASE_URL}_templates/{$THEME}/js/functions.js" type="text/javascript"></script>
<script src="{$BASE_URL}_templates/{$THEME}/js/main.js" type="text/javascript"></script>
<script src="{$BASE_URL}_templates/{$THEME}/js/categories.js" type="text/javascript"></script>
<script src="{$BASE_URL}_templates/{$THEME}/js/hoverIntent.js" type="text/javascript"></script>
<script src="{$BASE_URL}_templates/{$THEME}/js/links.js" type="text/javascript"></script>
<script src="{$BASE_URL}_templates/{$THEME}/js/select2.js" type="text/javascript"></script>
<script src="{$BASE_URL}_templates/{$THEME}/js/messages.js" type="text/javascript"></script>
<!-- <script src="{$BASE_URL}_templates/{$THEME}/js/overlay.js" type="text/javascript"></script> -->
<script src="{$BASE_URL}_templates/{$THEME}/js/types.js" type="text/javascript"></script>
<script src="{$BASE_URL}_templates/{$THEME}/js/jquery.fancybox.js" type="text/javascript"></script>
<script src="{$BASE_URL}_templates/{$THEME}/js/jquery.easing.1.3.js" type="text/javascript"></script>
<script src="{$BASE_URL}_templates/{$THEME}/js/jquery.timepicker.js" type="text/javascript"></script>
<script src="{$BASE_URL}_templates/{$THEME}/js/jquery-ui.min.js"></script>
<!-- <script src="{$BASE_URL}_templates/{$THEME}/js/core.js"></script> -->
<script src="{$BASE_URL}_templates/{$THEME}/js/widget.js"></script>
<script src="{$BASE_URL}_templates/{$THEME}/js/datepicker.js" type="text/javascript"></script>
<script src="{$BASE_URL}_templates/{$THEME}/js/accordion.js"></script>
<script src="{$BASE_URL}_templates/{$THEME}/js/croppie.js"></script>
{literal}
<style type="text/css">
.datetimeHeading{
	margin-bottom: 10px;
...
<script type="text/javascript">
  ...
  $.ajax({
  	type: "POST",
  	url: "{/literal}{$BASE_URL}add-appointment/add?ajax=y{literal}",
  	...
  	success: function(msg) 
  	{
		...
		$('#hour').on("change",function(e,ui){
			...
			$.ajax({ 
				type: "POST",
				url: "{/literal}{$BASE_URL}add-appointment/add?appoint=y{literal}",
