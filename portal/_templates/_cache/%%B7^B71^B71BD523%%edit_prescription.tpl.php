 ...
 -->
					<div class="col-sm-3">
						<div class="form-group">
							...
							<input type="text" class="form-control input-field" name="patient_name" id="patient_name" readonly="readonly" <?php if (( isset ( $this->_tpl_vars['data'] ) && $this->_tpl_vars['data']['patient']['name'] )): ?>value="<?php echo $this->_tpl_vars['data']['patient']['name']; ?>
"<?php endif; ?> />
						</div>
					</div>
					<div class="col-sm-3">
