<?php /* Smarty version 2.6.31, created on 2018-08-09 15:01:13
...
<?php if (isset ( $this->_tpl_vars['errors'] ) && $this->_tpl_vars['errors']['incorrect']): ?>
...
">
		<h3>Log into Admin Panel</h3>
		<div class="block_inner">
			<div class="group<?php if (isset ( $this->_tpl_vars['errors'] ) && $this->_tpl_vars['errors']['username']): ?> error<?php endif; ?>">
				<input type="text" name="username" id="username" size="20" value="<?php if (! empty ( $_POST['username'] )): ?><?php echo $_POST['username']; ?>
<?php endif; ?>" />
