<?php /* Smarty version 2.6.31, created on 2018-08-15 17:06:02
...
" class="form-control" />
					...
					<div class="col-sm-6">
						<div class="relative-border">
							...
							<input type="submit" name="submit" id="submit" value="<?php if ($this->_tpl_vars['edit']): ?> Update<?php else: ?> Add <?php endif; ?>" class="btn btn-primary" style="margin-top: 20px;"/>
						</div>
					</div>
				</div>
			</fieldset>
