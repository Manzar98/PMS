{include file="header.tpl"}
	...
	{if $links == ''}
		...
		<div class="information">If you want to hide a menu from the frontend simply remove all links from the corresponding menu.</div>
		
		<div class="list">
			<div class="row odd">
				<a class="right" href="{$BASE_URL_ADMIN}links/home/" title="Edit main menu"><img src="{$BASE_URL_ADMIN}_templates/img/pencil.png" alt="Edit" /></a>
				<h4 class="bold mb05">Home menu</h4>
				<div>The Home menu for your Website. This menu is located at home page under content.</div>
			</div>

			<div class="row even">
				<a class="right" href="{$BASE_URL_ADMIN}links/menu/" title="Edit main menu"><img src="{$BASE_URL_ADMIN}_templates/img/pencil.png" alt="Edit" /></a>
				<h4 class="bold mb05">Main menu</h4>
				<div>Main Menu for your Website.</div>
			</div>
<!--
			<div class="row odd">
		...
		{foreach from=$links item=menu}
			...
			<div class="linkItem" rel="{$menu[tmp].id}">
				...
				<div class="linkWrapper">
					...
					<label><span>Url:</span><input type="text" size="60" name="url{$menu[tmp].id}" value="{$menu[tmp].url}" /><img class="help" src="{$BASE_URL_ADMIN}_templates/img/information-balloon.png" title="The URL you want to link to. When you want to link to a page (e.g. the page Contact) you can use the URL (e.g. contact)" /></label>
