<?php /* Smarty version 2.6.26, created on 2012-04-19 08:37:09
...
links/home/" title="Edit main menu"><img src="<?php echo $this->_tpl_vars['BASE_URL_ADMIN']; ?>
_templates/img/pencil.png" alt="Edit" /></a>
			...
			<div class="row even">
				<a class="right" href="<?php echo $this->_tpl_vars['BASE_URL_ADMIN']; ?>
links/menu/" title="Edit main menu"><img src="<?php echo $this->_tpl_vars['BASE_URL_ADMIN']; ?>
_templates/img/pencil.png" alt="Edit" /></a>
...
" /><img class="help" src="<?php echo $this->_tpl_vars['BASE_URL_ADMIN']; ?>
_templates/img/information-balloon.png" title="The URL you want to link to. When you want to link to a page (e.g. the page Contact) you can use the URL (e.g. contact)" /></label>
