...
<div id="content" class="clientWrap">
	...
	<div class="row app_btns">
		...
		<div class="col-sm-2 common-bottom" >
			<a href="{$BASE_URL_ADMIN}doc-appointments/?doc_id={$doc.id}&doc_name={$doc.F_name} {$doc.L_name} &doc_adr={$doc.c_address}&doc_phne={$doc.phone}&img={$doc.profile_img}&speciallist={$doc.specialist}&exprience={$doc.exprience}&fee={$doc.c_fee}&exist=patient" class="btn btn-primary">Get Appointment</a>
		</div>
	</div>
