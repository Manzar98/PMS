		...
		<div class="row">
			...
			<div class="row doctor_Wrap">
				...
				<div class="col-sm-3 common-bottom complete_wrap">
					<a href="{$BASE_URL_ADMIN}appointments/view/{$doctors.id}/" class="docCard">
						<div class="card text-center cardWrap">
							<img class="card-img-top" src="{$BASE_URL_ADMIN}{$doctors.profile_img}" alt="Card image cap">
							<div class="card-body">
								<h5 class="card-title info_wrap">{$doctors.F_name} {$doctors.L_name}</h5>
								<p ><span class="info_wrap">{$doctors.specialist}</span> - <span class="info_wrap">{$doctors.city}</span></p>
							</div>
						</div>
					</a>
				</div>	
